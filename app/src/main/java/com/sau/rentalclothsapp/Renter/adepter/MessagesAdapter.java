...
import com.sau.rentalclothsapp.Renter.helper.CircleTransform;
import com.sau.rentalclothsapp.Renter.helper.FlipAnimator;
...
public class MessagesAdapter extends RecyclerView.Adapter<MessagesAdapter.MyViewHolder> {
    ...
    private void applyImportant(MyViewHolder holder, Message message) {
        if (message.isImportant()) {
           // holder.iconImp.setImageDrawable(ContextCompat.getDrawable(mContext, R.drawable.homedark));
            holder.iconImp.setColorFilter(ContextCompat.getColor(mContext, R.color.icon_tint_selected));
        } else {
           // holder.iconImp.setImageDrawable(ContextCompat.getDrawable(mContext, R.drawable.profiledark));
